...
customer_rol_df = pd.read_csv('/Users/razzak_lebbai/Desktop/customer_rol/data/customer_rol_us.csv',  nrows=None, parse_dates=parse_dates)
...
list_columns=['OPT_OUT_VALUE', 'ONLINE_SUB_CHANNEL', 'PROD_FMLY_GRP','PURCHASE_AR_FLAG', 'netsales_range','PSN_START_MONTH', 'EXPIRATION_DATE_MONTH','EXPIRATION_DATE_YEAR']
list_df=[]
...
for col in ret_list_columns:
    ret_list_df.append(create_retGroups(customer_rol_df, ret_gpby=col, deci=2))
